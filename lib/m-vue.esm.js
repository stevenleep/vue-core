...
function createRenderer(customRenderOptions) {
    ...
    function patchChildren(n1, n2, el, parentComponent) {
        ...
        if ((oldShapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */) & (newShapeFlag & 8 /* ShapeFlags.ARRAY_CHILDREN */)) {
...
export { ReactiveEffect, clearCurrentInstance, computed, createApp, createComponentInstance, createRenderer, createTextVNode, createVNode, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, isShallowReactive, isShallowReadonly, isTracking, mutableHandlers, provide, proxyRefs, reactive, readonly, readonlyHandlers, ref, renderSlots, setCurrentInstance, setupComponent, shallowReactive, shallowReactiveHandlers, shallowReadonly, shallowReadonlyHandlers, stop, track, trackEffects, trigger, triggerEffects, unRef, useInject };
